...
if __name__ == '__main__':
    ...
    width_values = [3, 5, 10, 100, 200]
    height_values = width_values
    obstacle_percentage_values = [0.0, 0.2, 0.5, 0.9]
    conglomeration_ratio_values = [0.0, 0.4, 0.7]
    max_length_agents_values = [3, 8, 20]
    num_agents_values = [1, 3, 10]
    max_length_values = [10, 100, 1000]
    metric_values = [0, 1]
    time_limit_values = [1, 10, 20] #tempi in secondi
